                        ...
                        <div class="card-content">
                            ...
                            <div class="box">
                                <article class="media">
                                    ...
                                    <div class="media-content">
                                        <div class="content">
                                            <li><a class="button is-dark is-4" href="<?= FRONT_ROOT ?>Admin/ShowAddView">Agregar Administrador</a><br><br></li>

                                            <li><a class="button is-dark is-4" href="<?= FRONT_ROOT ?>Admin/ShowListView">Listar Administradores </a> </li>
                                        </div>
                                    </div>
                                </article>
                            </div>
